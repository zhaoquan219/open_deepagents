...
export const messages = {
  zh: {
    ...
    app: {
      ...
      topbarStatus: {
        running: '当前任务正在处理，回复、思考和工具过程会按时间写入中间消息流。',
  ...
  en: {
    ...
    app: {
      ...
      topbarStatus: {
        running: 'The current task is running. Replies, thinking, and tool activity are logged in the conversation.',
        ...
        failed: 'The last run was interrupted. The conversation keeps the error context for retry.',
    ...
    workspace: {
      ...
      runtimeCopy: {
        ...
        failed: 'This run failed. The error is kept in the conversation for retry.',
