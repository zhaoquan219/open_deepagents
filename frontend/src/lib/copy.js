...
export const messages = {
  zh: {
    ...
    sidebar: {
      ...
      refresh: "刷新",
      searchAria: "搜索会话",
      searchPlaceholder: "搜索标题或消息关键字",
      searchEmpty: "没有匹配的会话，换个关键字试试。",
      loading: "正在加载会话…",
  ...
  en: {
    ...
    sidebar: {
      ...
      searchPlaceholder: "Search title or message keywords",
      searchEmpty: "No sessions match your search. Try another keyword.",
